...
display( void )
{
    ...
    // Some fractals:
    //generateLateral(Sphere,2.0, RotateY(Theta4[Xaxis]), vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));
    //generateLateral(Sphere,4.0, RotateY(Theta4[Xaxis]), vec3(0.0, 0.0, 0.0), vec3(1.6, 1.6, 1.6));
    generateLateral(Sphere, 2.0, RotateY(Theta4[Xaxis]), vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));
    //generateVertical(Cube, 4.0, RotateX(Theta4[Xaxis]), vec3(0.0,0.0,0.0), vec3(1.4,1.4,1.4));
    
    
    // colony generator:
    //generateColony(Cube, Cube, 4.0, 1.3, RotateY(Theta4[Xaxis]), vec3(0.0,0.0,0.0), vec3(1.0,1.0,1.0));
